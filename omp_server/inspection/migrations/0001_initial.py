# Generated by Django 3.1.4 on 2021-10-15 15:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inspection_name', models.CharField(help_text='报告名称', max_length=256)),
                ...
                ('hosts', models.JSONField(blank=True, help_text='巡检主机', null=True)),
                ...
                ('end_time', models.DateTimeField(help_text='开始时间', null=True)),
                ('duration', models.IntegerField(default=0, help_text='巡检用时：单位s')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inst_id', models.ForeignKey(help_text='巡检记录历史表id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='inspection.inspectionhistory', verbose_name='巡检记录历史表')),
            ],
            options={
