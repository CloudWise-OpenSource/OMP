            ...
            if alert_list[i].alert_type=='service':
                ...
                if alert_ser.count() == 0:
                    SelfHealingHistory.objects.create(
                        ...
                        start_time=alert_list[i].create_time,
                        # monitor_path=alert_list[i].monitor_path,
